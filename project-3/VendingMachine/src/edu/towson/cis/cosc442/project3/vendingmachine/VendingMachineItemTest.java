...
public class VendingMachineItemTest {
	...
	/**
	 * Test method for {@link edu.towson.cis.cosc442.project2.vendingmachine.VendingMachineItem#VendingMachineItem(java.lang.String, double)}.
	 * Testing the constructor to make sure it throws error when price of item is less than zero
	 */
	@Test (expected = VendingMachineException.class)
	public void testVendingMachineItemInvalidPrice() {
		// test oracle
		VendingMachineItem pepsi = new VendingMachineItem("pepsi", -1);
	}
